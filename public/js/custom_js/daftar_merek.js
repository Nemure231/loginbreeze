...
ready(function () {
  ...
  const dataTable = new simpleDatatables.DataTable("#tabel-merek", {
    searchable: true,
    fixedHeight: true,
...
ready(function () {
  ...
  Array.prototype.forEach.call(tombolEdit, function (element) {
    element.addEventListener('click', function () {
      ...
      e1ModalEdit.addEventListener('shown.bs.modal', function (e) {
        ...
        document.getElementById('e-nama-merek').value = element.dataset.nama_merek;
        document.getElementById('form-edit').setAttribute("action", "/merek/" + element.dataset.id_merek);
        ///fungsi menyimpan data terakhir di local browser
        var id_merek = element.dataset.id_merek;
       
        localStorage.setItem("simpan_id_merek", id_merek);
      });
    });
  ...
  Array.prototype.forEach.call(tombolHapus, function (element) {
    element.addEventListener('click', function () {
      ...
      e1ModalHapus.addEventListener('shown.bs.modal', function (e) {
        ...
        document.getElementById('form-hapus').setAttribute("action", "/merek/" + element.dataset.id_merek);
  ...
  var tambah = document.getElementById('pesan-validasi-merek').innerHTML;
  var edit = document.getElementById('pesan-validasi-edit-merek').innerHTML;
  ...
  var id_merek = localStorage.getItem("simpan_id_merek");
  ...
  modalEdit.addEventListener('shown.bs.modal', function (event) {
    ...
    document.getElementById('form-edit').setAttribute("action", "/merek/" + id_merek);
