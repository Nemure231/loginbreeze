    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                ...
                                <form method="post" action="{{ url('barang/import') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="input-group mb-3 mt-3">
                                        ...
                                        <button class="btn btn-outline-secondary" type="submit"
                                            id="button-addon2">Import Excel</button>
                                ...
                                @foreach ($barang as $db)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-warning tombolEdit"
                                                data-nama_barang="{{ $db['nama_barang'] }}"
                                                data-merek_id="{{ $db['merek_id'] }}"
                                                data-satuan_id="{{ $db['satuan_id'] }}"
                                                data-harga_barang="{{ $db['harga_barang'] }}"
            ...
            @endif --}}
                        ...
                        <div class="invisible" id="pesan_validasi_barang">0 @error('harga_barang')
                                {{ $message }}
                            @enderror
                            @error('nama_barang')
                                {{ $message }}
                                @enderror @error('satuan_id')
                                {{ $message }}
                            @enderror
                            @error('merek_id')
                                {{ $message }}
                        ...
                        <div class="invisible" id="pesan_validasi_edit_barang">0 @error('e_harga_barang')
                                {{ $message }}
                            @enderror
                            @error('e_nama_barang')
                                {{ $message }}
                                @enderror @error('e_satuan_id')
                                {{ $message }}
                            @enderror
                            @error('e_merek_id')
                                {{ $message }}
                                            ...
                                            <div class="row">
                                                    ...
                                                    <select class="form-select @error('satuan_id') is-invalid @enderror"
                                                        ...
                                                        @foreach ($satuan as $s)
                                                            <option value={{ $s['id_satuan'] }}
                                                                {{ old('satuan_id') == $s['id_satuan'] ? 'selected' : '' }}>
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <select class="form-select @error('merek_id') is-invalid @enderror"
                                                        id="merek_id" name="merek_id"
                                                        aria-label="Floating label select example">
                                                        <option selected value="">--Pilih--</option>

                                                        @foreach ($merek as $m)
                                                            <option value={{ $m['id_merek'] }}
                                                                {{ old('merek_id') == $m['id_merek'] ? 'selected' : '' }}>
                                                                {{ $m['nama_merek'] }}</option>
                                                        @endforeach
                        ...
                        <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    ...
                                    <form method="post" id="form_edit">
                                        ...
                                        <div class="modal-body" id="modalBodyEdit">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-3">
                                                    <label>Nama Barang</label>
                                                    <input type="text" name="e_nama_barang"
                                                        value="{{ old('e_nama_barang') }}"
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <label>Harga Barang</label>
                                                    <input type="text" name="e_harga_barang"
                                                        value="{{ old('e_harga_barang') }}"
                            ...
                            @endforeach --}}
                                                        @foreach ($satuan as $s)
                                                            <option value={{ $s['id_satuan'] }}
                                                                {{ old('e_satuan_id') == $s['id_satuan'] ? 'selected' : '' }}>
                                                                {{ $s['nama_satuan'] }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback" id="hapus-validasi">
                            ...
                            @endforeach --}}
                                                        ...
                                                        @foreach ($merek as $m)
                                                            <option value={{ $m['id_merek'] }}
                                                                {{ old('e_merek_id') == $m['id_merek'] ? 'selected' : '' }}>
                                                                {{ $m['nama_merek'] }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback" id="hapus-validasi">
